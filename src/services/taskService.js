    ...
    const task = {
        ...
        registered_customer_data: {
            ...
            additional_documents: row.additional_documents_id ? {
                ...
                solar_panel_summary_image_url: row.solar_panel_summary_image_url,
                inverter_image_url: row.inverter_image_url,
                applicant_with_panel_image_url: row.applicant_with_panel_image_url,
                applicant_with_invertor_image_url: row.applicant_with_invertor_image_url,
...
async function list(filters = {}) {
    ...
    rc.site_image_gps_url,
      ...
      e.phone_number as creator_phone,
            ...
            ad.solar_panel_summary_image_url,
...
async function validateDocumentRequirements(workType, customerId) {
    ...
    const documentRequirements = {
        ...
        'upload_installed_item_serial_number': {
            table: 'additional_documents',
            fields: ['solar_panel_summary_image_url'],
            message: 'Solar panel summary image must be uploaded before completing this task'
        },
        'generate_bill': {
            table: 'additional_documents',
